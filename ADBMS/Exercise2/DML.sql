...
-- 9
select first_name,last_name from employees where hire_date between '1995-01-01' and '1998-01-01';
-- 10
select  job_title from jobs where max_salary<5000;
-- 11
select lower(email) from employees;
-- 12 
select first_name,last_name from employees where hire_date between '1995-01-01' and '1996-01-01';
-- OR select first_name,last_name from employees where hire_date like '1995%';
-- 13
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES(150,'Paul','Newton','paul.newton@sqltutorial.org','535.963.4500','1987-05-27',6,26000.00,NULL,11);
-- 14
